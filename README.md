...
### Overview
A smart and intuitive application/solution that attempts to free the user from as much as possible the burden of manual calculation while keeping track of their finances and expenditure easily using Artificial Intelligence (AI) assisted Financial Management & Advice with the help of various Machine Learning techniques, models, algorithms and implementations to provide a simple custom and tailored experience to the user in realtime, all in one place using a simple application on their mobile device. 
